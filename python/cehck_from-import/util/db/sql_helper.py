...
def get_common_value():
    return COMMON_VALUE_1 + ":" + COMMON_VALUE_2 + ":" + COMMON_VALUE_2 + ":" + COMMON_VALUE_2


def get_util_const_common_const():
    return util_const_common_const.COMMON_VALUE_1 + ":" + util_const_common_const.COMMON_VALUE_2
