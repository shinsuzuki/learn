@echo off
rem ============================================================================
rem DB_CollectLog_ExtractAlert.bat: 特定のEventIDを抽出
rem ============================================================================

echo start DB_CollectLog_ExtractAlert.bat
...
set psScriptFile=D:\NikonLDS\Maintenance\ErrorCheck\DB_CollectLog_ExtractAlert.ps1
...
echo end DB_CollectLog_ExtractAlert.bat
rem exit
pause
